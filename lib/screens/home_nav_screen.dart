...
import 'package:mallsystem/screens/user_search_locations_screen.dart';
...
import '../routing/models/Graph.dart';
...
class _HomeNavigationScreenState extends State<HomeNavigationScreen> {
  ...
  //mall location constants

  // final LatLng mallLocation =
  //     const LatLng(27.734613100898645, 85.31073584507607);
  // final double zoomLevel = 17.64417266845703; // Adjust if necessary
  // final double bearing = 220.48236083984375; // Adjust if necessary
  // final LatLng swLimit =
  //     const LatLng(27.733000, 85.309000); // Update with new limits
  // final LatLng neLimit = const LatLng(27.736000, 85.312000);
